import 'package:h_cash/marketplace/address_add_response.dart';
import 'package:h_cash/marketplace/address_delete_response.dart';
import 'package:h_cash/marketplace/address_make_default_response.dart';
import 'package:h_cash/marketplace/address_response.dart';
import 'package:h_cash/marketplace/address_update_in_cart_response.dart';
import 'package:h_cash/marketplace/address_update_location_response.dart';
import 'package:h_cash/marketplace/address_update_response.dart';
import 'package:h_cash/marketplace/city_response.dart';
import 'package:h_cash/marketplace/country_response.dart';
import 'package:h_cash/marketplace/shared_value_helper.dart';
import 'package:h_cash/marketplace/shipping_cost_response.dart';
import 'package:h_cash/marketplace/state_response.dart';
...
class AddressRepository {
  Future<AddressResponse> getAddressList() async {
    Uri url = Uri.parse("$shabelleAPI/user/shipping/address");
  ...
  Future<AddressResponse> getHomeDeliveryAddress() async {
    Uri url = Uri.parse("$shabelleAPI/get-home-delivery-address");
    final response = await http.get(
      url,
      headers: {
        "Content-Type": "application/json",
  ...
  Future<AddressAddResponse> getAddressAddResponse(
    ...
    Uri url = Uri.parse("$shabelleAPI/user/shipping/create");
  ...
  Future<AddressUpdateResponse> getAddressUpdateResponse(
    ...
    Uri url = Uri.parse("$shabelleAPI/user/shipping/update");
    final response = await http.post(url,
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer ${access_token.$}",
  ...
  Future<AddressUpdateLocationResponse> getAddressUpdateLocationResponse(
    ...
    Uri url = Uri.parse("$shabelleAPI/user/shipping/update-location");
    final response = await http.post(url,
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer ${access_token.$}",
  ...
  Future<AddressMakeDefaultResponse> getAddressMakeDefaultResponse(
    ...
    Uri url = Uri.parse("$shabelleAPI/user/shipping/make_default");
    final response = await http.post(url,
        headers: {
          "Content-Type": "application/json",
          "Content-Type": "application/json",
  ...
  Future<AddressDeleteResponse> getAddressDeleteResponse(
    ...
    Uri url = Uri.parse("$shabelleAPI/user/shipping/delete/$id");
    final response = await http.get(
      url,
      headers: {
        "Authorization": "Bearer ${access_token.$}",
  ...
  Future<CityResponse> getCityListByState({state_id = 0, name = ""}) async {
    Uri url =
        Uri.parse("$shabelleAPI/cities-by-state/${state_id}?name=${name}");
  ...
  Future<MyStateResponse> getStateListByCountry(
    ...
    Uri url =
        Uri.parse("$shabelleAPI/states-by-country/${country_id}?name=${name}");
    final response = await http.get(url);
    return myStateResponseFromJson(response.body);
  }

  Future<CountryResponse> getCountryList({name = ""}) async {
    Uri url = Uri.parse("$shabelleAPI/countries?name=${name}");
    final response = await http.get(url);
  ...
  Future<ShippingCostResponse> getShippingCostResponse(
    ...
    Uri url = Uri.parse("$shabelleAPI/shipping_cost");
    print(url.toString());
    final response = await http.post(url,
        headers: {
          "Content-Type": "application/json",
  ...
  Future<AddressUpdateInCartResponse> getAddressUpdateInCartResponse(
    ...
    Uri url = Uri.parse("$shabelleAPI/update-address-in-cart");
    final response = await http.post(url,
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer ${access_token.$}",
  ...
  Future<AddressUpdateInCartResponse> getShippingTypeUpdateInCartResponse(
    ...
    Uri url = Uri.parse("$shabelleAPI/update-shipping-type-in-cart");
