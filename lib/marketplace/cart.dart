...
import 'package:h_cash/marketplace/select_address.dart';
...
class _CartState extends State<Cart> {
  ...
  onQuantityIncrease(seller_index, item_index) {
    if (_shopList[seller_index].cart_items[item_index].quantity <
      ...
      ToastComponent.showDialog(
          "You cannot order more than ${_shopList[seller_index].cart_items[item_index].upper_limit} items of this",
  ...
  onQuantityDecrease(seller_index, item_index) {
    if (_shopList[seller_index].cart_items[item_index].quantity >
      ...
      ToastComponent.showDialog(
          "You cannot order less than ${_shopList[seller_index].cart_items[item_index].lower_limit} items of this",
          gravity: Toast.center,
          duration: Toast.lengthLong);
    }
  }
  ...
  process({mode}) async {
    ...
    if (cart_ids.length == 0) {
      ToastComponent.showDialog('Cart is empty',
          gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
