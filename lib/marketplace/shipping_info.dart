...
import 'package:h_cash/marketplace/address_repository.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';
import 'package:h_cash/marketplace/checkout.dart';
import 'package:h_cash/marketplace/delivery_info_response.dart';
import 'package:h_cash/marketplace/fade_network_image.dart';
import 'package:h_cash/marketplace/lang_text.dart';
import 'package:h_cash/marketplace/shared_value_helper.dart';
import 'package:h_cash/marketplace/shimmer_helper.dart';
import 'package:h_cash/marketplace/shipping_repository.dart';
import 'package:h_cash/marketplace/text_styles.dart';
import 'package:h_cash/marketplace/toast_component.dart';
import 'package:h_cash/marketplace/useful_elements.dart';
...
class _ShippingInfoState extends State<ShippingInfo> {
  ...
  getDeliveryInfo() async {
    ...
    _deliveryInfoList.forEach((element) {
      ...
      var shippingId =
          carrier_base_shipping.$ ? element.carriers!.data!.first.id : 0;
...
*/
          ...
          child: Row(
            ...
            children: [
              Container(
                width: 75,
                child: Text(
                  AppLocalizations.of(context)!.shipping_info_screen_address,
                  style: TextStyle(
                    fontSize: 13,
  ...
  Container buildCarrierNoData() {
    return Container(
        ...
        child: Center(
            child: Text(
          AppLocalizations.of(context)!.shipping_info_screen_no_carrier_point,
          style: TextStyle(color: MyTheme.font_grey),
        )));
  }
  ...
  ElevatedButton buildPickUpPointOption(BuildContext context, sellerIndex) {
  ...
  ElevatedButton buildAddressOption(BuildContext context, sellerIndex) {
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        backgroundColor:
            _sellerWiseShippingOption[sellerIndex].shippingOption ==
  ...
  ElevatedButton buildCarrierOption(BuildContext context, sellerIndex) {
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        backgroundColor:
            _sellerWiseShippingOption[sellerIndex].shippingOption ==
