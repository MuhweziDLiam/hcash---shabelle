...
import 'package:h_cash/marketplace/map_location.dart';
...
class _AddressState extends State<Address> {
  ...
  onSelectCountryDuringUpdate(index, country, setModalState) {
    ...
    _selected_state_list_for_update[index] = _selected_state!;
    _selected_city_list_for_update[index] = _selected_city!;
    setState(() {});
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      ...
                      maximumSize: Size.fromHeight(90),
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TypeAheadField(
                            ...
                            itemBuilder: (context, MyState? state) {
                              //print(suggestion.toString());
                              return ListTile(
                                dense: true,
                                title: Text(
